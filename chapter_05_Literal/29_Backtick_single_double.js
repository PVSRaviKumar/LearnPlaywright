...
// In JavaScript:
// - Single quotes '...' and double quotes "..." create normal string literals.
// - Backticks `...` create template literals, which can include expressions and multi-line text.

const single = 'Hello';
const double = "Hello";
const backtick = `Hello, ${single}!`;

console.log('single:', single); // single: Hello
console.log('double:', double); // double: Hello
console.log('backtick:', backtick); // backtick: Hello, Hello!

// Key difference:
// - single and double quotes are mostly interchangeable for plain strings.
// - backticks allow interpolation with ${...} and can span multiple lines.
